...
if [ $language == "Python" ] ; then
    ...
    $replace -i '' -e "s/Day/$day/g" $path_length'/src/'$project_name'/main.py'
	$replace -i '' -e "s/Month/$month/g" $path_length'/src/'$project_name'/main.py'
	$replace -i '' -e "s/Year/$year/g" $path_length'/src/'$project_name'/main.py'
	$replace -i '' -e "s/Name/$name/g" $path_length'/src/'$project_name'/main.py'
	$replace -i '' -e "s/Company/$company/g" $path_length'/src/'$project_name'/main.py'
	$replace -i '' -e "s/filename/main/g" $path_length'/src/'$project_name'/main.py'
	$replace -i '' -e "s/Name/$name/g" $path_length'/src/'$project_name'/__init__.py'
	$replace -i '' -e "s/Company/$company/g" $path_length'/src/'$project_name'/__init__.py'
